      ...
      <v-container>
        <v-row class="my-10">
          <div class="hidden-sm-and-down">
            ...
            <a style="font-size: calc(1vh + 7px); color: #fdd000" class="mx-2">WE TOKEN X Manager Dashboard</a>
          </v-col>
          </div>
          <div class="hidden-md-and-up">
            ...
            <h1 style="font-size: 2rem" class="text-center mx-3 textcontent--text">></h1>
            <img src="../static/Weserve Token-06.png" style="height: 33px; width: 34px" />
            <a style="font-size: calc(0.7vh + 7px); color: #fdd000" class="mx-2">WE TOKEN X Manager Dashboard</a>
          </v-col>
          </div>  
        </v-row>
              ...
              <v-card @click="getPage(index)">
                ...
                <v-card-text class="d-flex justify-space-between mb-15">
                  <v-card-text class="d-flex">
                    ...
                    <h1 style="font-size: calc(1vh + 10px)">{{ i.title }}</h1>
                  </v-card-text>
                </v-card-text>
              </v-card>
            </div>
...
export default {
  ...
  methods: {
    getPage(i) {
      this.setRouter = i;
      if (i === 0) {
        window.location.href = "/Weserve";
      } else if (i === 1) {
        window.location.href = "/Wesmart";
      } else if (i === 2) {
